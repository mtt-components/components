...
mkdir -p $ROOT/temp
remote="https://codeload.github.com/mtt-components/${repos}/tar.gz/${version}"
...
info="https://raw.githubusercontent.com/mtt-components/${repos}/${version}/component.json"
...
versions=$(git ls-remote --tags --refs --heads https://github.com/mtt-components/${repos}.git  | awk -F/ '{print $3}')
